...
static const std::map<FLUPS_CenterType, std::string> cname = {
    {NODE_CENTER, "node"}, 
    {CELL_CENTER, "cell"}
};
static const std::map<FLUPS_GreenType, std::string> kname = {
    {CHAT_2, "chat2"}, 
    {LGF_2, "lgf2"}, 
    {LGF_4, "lgf4"}, 
    {LGF_6, "lgf6"}, 
...
static const std::map<FLUPS_BoundaryType, std::string> bname = {
    {EVEN, "0"},
    {ODD, "1"}, 
    {PER, "3"},
    {UNB, "4"}
