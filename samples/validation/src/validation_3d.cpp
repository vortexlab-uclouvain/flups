...
// void validation_3d(const DomainDescr myCase, const SolverType type, const GreenType typeGreen, const int nSolve) {
    ...
    FLUPS_Topology *topo = flups_topo_new(0, nglob, nproc, false, NULL, FLUPS_ALIGNMENT, MPI_COMM_WORLD);
    // const Topology *topo    = new Topology(0, nglob, nproc, false, NULL,FLUPS_ALIGNMENT,MPI_COMM_WORLD);
