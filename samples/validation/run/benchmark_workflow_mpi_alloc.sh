...
SUBMISSION_NAME=xplore_mpi_alloc_flups-${MPI_VERSION}-${TAG}
...
export COMPILE_OPTIONS=(" " "-DMPI_NO_ALLOC")
export COMPILE_PREFIXES=("mpi_alloc" "system_alloc")
export SCRATCH_DIR_LIST='mpi_alloc system_alloc'
