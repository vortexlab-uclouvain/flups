...
SCRATCH=/SCRATCH/acad/examples/tgillis/flups_weak_nb_large_6_plum
...
cp $HOME_FLUPS/run/zenobe_kernelScaling_large.sh $SCRATCH
cd $SCRATCH
...
qsub -q R4661004 -v MY_NX=${NX},MY_NY=${NY},MY_NZ=${NZ},MY_SIZE_X=${SIZE_X},MY_SIZE_Y=${SIZE_Y},MY_SIZE_Z=${SIZE_Z},MY_NTH=1,L_X=${LX},L_Y=${LY},L_Z=${LZ},EXEC_FLUPS=${EXEC_FLUPS} -l select=${N_NODE}:ncpus=24:mem=63000mb:mpiprocs=24:ompthreads=1 ./zenobe_kernelScaling_large.sh
#-- 4 thread
export NX2=$NX
...
qsub -q R4661004 -v MY_NX=${NX2},MY_NY=${NY2},MY_NZ=${NZ2},MY_SIZE_X=${SIZE_X},MY_SIZE_Y=${SIZE_Y},MY_SIZE_Z=${SIZE_Z},MY_NTH=4,L_X=${LX},L_Y=${LY},L_Z=${LZ},EXEC_FLUPS=${EXEC_FLUPS} -l select=${N_NODE}:ncpus=24:mem=63000mb:mpiprocs=6:ompthreads=4 ./zenobe_kernelScaling_large.sh
...
SCRATCH=/SCRATCH/acad/examples/tgillis/flups_weak_a2a_large_6_plum
