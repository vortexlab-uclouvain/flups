...
HOME_FLUPS=/home/pr1ekt00/$(whoami)/flups/samples/validation
SCRATCH_FLDR=/gpfs/scratch/pr1ekt00/$(whoami)
...
SCRATCH=${SCRATCH_FLDR}/flups_weak_nb_${SIZE_PER_PROC}_${ver}
