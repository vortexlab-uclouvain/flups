...
echo "CXXFLAGS := -g -O3 -std=c++17 -DMPI_BATCH_SEND=1 -DNDEBUG -march=native #-DNO_PROF" >> make_arch/make.meluxina
echo "CCFLAGS :=  -g -O3 -std=c99   -DMPI_BATCH_SEND=1 -DNDEBUG -march=native #-DNO_PROF" >> make_arch/make.meluxina
