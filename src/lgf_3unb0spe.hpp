...
void mehr_4l6l_2unb0spe_expansion(double* G, const double n1, const double n2, const double n) {
  const double n1_4 = pow(n1, 4);
  const double n1_6 = pow(n1, 6);
  const double n1_8 = pow(n1, 8);
  const double n1_10 = pow(n1, 10);
  ...
  const double n2_14 = pow(n2, 14);
  const double n2_16 = pow(n2, 16);
  G[0] = (0.02976190476190476 * n1_12 + -0.7738095238095238 * n1_10 * (n2 * n2) + 0.44642857142857145 * n1_8 * n2_4 + 2.5 * n1_6 * n2_6 + 0.44642857142857145 * n1_4 * n2_8 + -0.7738095238095238 * (n1 * n1) * n2_10 + 0.02976190476190476 * n2_12) / (M_PI * pow(n, 18)) + (0.175 * n1_16 + -4.2 * n1_14 * (n2 * n2) + -6.3 * n1_12 * n2_4 + 15.4 * n1_10 * n2_6 + 34.65 * n1_8 * n2_8 + 15.4 * n1_6 * n2_10 + -6.3 * n1_4 * n2_12 + -4.2 * (n1 * n1) * n2_14 + 0.175 * n2_16) / (M_PI * pow(n, 24)) + (0.016666666666666666 * n1_8 + -0.06666666666666667 * n1_6 * (n2 * n2) + -0.16666666666666666 * n1_4 * n2_4 + -0.06666666666666667 * (n1 * n1) * n2_6 + 0.016666666666666666 * n2_8) / (M_PI * pow(n, 12)) + -0.15915494309189535 * (1.6169364357414509 + log(n));
}

void mehr_4f_2unb0spe_expansion(double* G, const double n1, const double n2, const double n) {
  const double n1_4 = pow(n1, 4);
  const double n1_6 = pow(n1, 6);
  const double n1_8 = pow(n1, 8);
  const double n1_10 = pow(n1, 10);
  ...
  const double n2_18 = pow(n2, 18);
  const double n2_20 = pow(n2, 20);
  G[0] = (0.32083333333333336 * n1_16 + -7.7 * n1_14 * (n2 * n2) + -11.55 * n1_12 * n2_4 + 28.233333333333334 * n1_10 * n2_6 + 63.525 * n1_8 * n2_8 + 28.233333333333334 * n1_6 * n2_10 + -11.55 * n1_4 * n2_12 + -7.7 * (n1 * n1) * n2_14 + 0.32083333333333336 * n2_16) / (M_PI * pow(n, 24)) + (3.712121212121212 * n1_20 + -230.15151515151516 * n1_18 * (n2 * n2) + 879.7727272727273 * n1_16 * n2_4 + 2464.848484848485 * n1_14 * n2_6 + -1833.7878787878788 * n1_12 * n2_8 + -6370.0 * n1_10 * n2_10 + -1833.7878787878788 * n1_8 * n2_12 + 2464.848484848485 * n1_6 * n2_14 + 879.7727272727273 * n1_4 * n2_16 + -230.15151515151516 * (n1 * n1) * n2_18 + 3.712121212121212 * n2_20) / (M_PI * pow(n, 30)) + (0.02976190476190476 * n1_12 + -0.7738095238095238 * n1_10 * (n2 * n2) + 0.44642857142857145 * n1_8 * n2_4 + 2.5 * n1_6 * n2_6 + 0.44642857142857145 * n1_4 * n2_8 + -0.7738095238095238 * (n1 * n1) * n2_10 + 0.02976190476190476 * n2_12) / (M_PI * pow(n, 18)) + (0.058333333333333334 * n1_8 + -0.23333333333333334 * n1_6 * (n2 * n2) + -0.5833333333333334 * n1_4 * n2_4 + -0.23333333333333334 * (n1 * n1) * n2_6 + 0.058333333333333334 * n2_8) / (M_PI * pow(n, 12)) + -0.15915494309189535 * (1.6169364357414509 + log(n));
}

void mehr_6f_2unb0spe_expansion(double* G, const double n1, const double n2, const double n) {
  const double n1_4 = pow(n1, 4);
  const double n1_6 = pow(n1, 6);
  const double n1_8 = pow(n1, 8);
  const double n1_10 = pow(n1, 10);
  ...
  const double n2_14 = pow(n2, 14);
  const double n2_16 = pow(n2, 16);
  G[0] = (0.02976190476190476 * n1_12 + -0.7738095238095238 * n1_10 * (n2 * n2) + 0.44642857142857145 * n1_8 * n2_4 + 2.5 * n1_6 * n2_6 + 0.44642857142857145 * n1_4 * n2_8 + -0.7738095238095238 * (n1 * n1) * n2_10 + 0.02976190476190476 * n2_12) / (M_PI * pow(n, 18)) + (-0.175 * n1_16 + 4.2 * n1_14 * (n2 * n2) + 6.3 * n1_12 * n2_4 + -15.4 * n1_10 * n2_6 + -34.65 * n1_8 * n2_8 + -15.4 * n1_6 * n2_10 + 6.3 * n1_4 * n2_12 + 4.2 * (n1 * n1) * n2_14 + -0.175 * n2_16) / (M_PI * pow(n, 24)) + -0.15915494309189535 * (1.6169364357414509 + log(n));
}
