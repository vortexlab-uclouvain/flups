...
void lgf_8_2unb0spe_expansion(double* G, const double n1, const double n2, const double n) {
  ...
  const double n2_22 = pow(n2, 22);
  const double n2_24 = pow(n2, 24);
  G[0] = -0.15915494309189535 * (1.6169364357414509 + log(n)) + (4.0 * n1_16 + 4.0 * n2_16 + -96.0 * (n1 * n1) * n2_14 + 352.0 * n1_6 * n2_10 + 792.0 * n1_8 * n2_8 + -96.0 * n1_14 * (n2 * n2) + -144.0 * n1_4 * n2_12 + -144.0 * n1_12 * n2_4 + 352.0 * n1_10 * n2_6) / (M_PI * pow(n, 24)) + (-65.45454545454545 * n1_20 + -65.45454545454545 * n2_20 + -43461.818181818184 * n1_14 * n2_6 + 112320.0 * n1_10 * n2_10 + 4058.181818181818 * n1_18 * (n2 * n2) + -15512.727272727272 * n1_16 * n2_4 + -15512.727272727272 * n1_4 * n2_16 + -43461.818181818184 * n1_6 * n2_14 + 32334.545454545456 * n1_12 * n2_8 + 4058.181818181818 * (n1 * n1) * n2_18 + 32334.545454545456 * n1_8 * n2_12) / (M_PI * pow(n, 30)) + (1157.5384615384614 * n1_24 + 1157.5384615384614 * n2_24 + 1.2397236923076923e6 * n1_8 * n2_16 + -69452.30769230769 * n1_22 * (n2 * n2) + 1.2397236923076923e6 * n1_16 * n2_8 + 131959.38461538462 * n1_20 * n2_4 + -69452.30769230769 * (n1 * n1) * n2_22 + -5.11632e6 * n1_12 * n2_12 + 131959.38461538462 * n1_4 * n2_20 + 1.2455113846153845e6 * n1_18 * n2_6 + 1.2455113846153845e6 * n1_6 * n2_18 + -2.3613784615384615e6 * n1_10 * n2_14 + -2.3613784615384615e6 * n1_14 * n2_10) / (M_PI * pow(n, 36));
}
...
void mehr_6l_3unb0spe_expansion(double* G, const double n1, const double n2, const double n3, const double n) {
  ...
  const double n3_18 = pow(n3, 18);
  const double n3_20 = pow(n3, 20);
  G[0] = (0.029166666666666667 * n1_8 + 0.029166666666666667 * n2_8 + 0.029166666666666667 * n3_8 + -0.11666666666666667 * n1_4 * n2_4 + -0.029166666666666667 * n1_6 * (n2 * n2) + -0.029166666666666667 * (n1 * n1) * n2_6 + -0.029166666666666667 * n1_6 * (n3 * n3) + -0.029166666666666667 * n2_6 * (n3 * n3) + -0.029166666666666667 * (n1 * n1) * n3_6 + -0.029166666666666667 * (n2 * n2) * n3_6 + -0.11666666666666667 * n1_4 * n3_4 + -0.11666666666666667 * n2_4 * n3_4 + -0.37916666666666665 * n1_4 * (n2 * n2) * (n3 * n3) + -0.37916666666666665 * (n1 * n1) * n2_4 * (n3 * n3) + -0.37916666666666665 * (n1 * n1) * (n2 * n2) * n3_4) / (M_PI * pow(n, 13)) + (0.07552083333333333 * n1_12 + 0.07552083333333333 * n2_12 + 0.07552083333333333 * n3_12 + -0.984375 * (n1 * n1) * n2_10 + 4.057291666666667 * n1_6 * n2_6 + 0.96875 * n1_4 * n2_8 + 4.057291666666667 * n1_6 * n3_6 + -0.984375 * (n1 * n1) * n3_10 + 0.96875 * n1_8 * n2_4 + 0.96875 * n1_8 * n3_4 + -0.984375 * n1_10 * (n2 * n2) + 0.96875 * n1_4 * n3_8 + 0.96875 * n2_4 * n3_8 + 0.96875 * n2_8 * n3_4 + -0.984375 * n1_10 * (n3 * n3) + 4.057291666666667 * n2_6 * n3_6 + -0.984375 * n2_10 * (n3 * n3) + -0.984375 * (n2 * n2) * n3_10 + 0.578125 * n1_6 * n2_4 * (n3 * n3) + -5.171875 * n1_8 * (n2 * n2) * (n3 * n3) + 0.578125 * n1_4 * (n2 * n2) * n3_6 + 0.578125 * n1_6 * (n2 * n2) * n3_4 + 4.8046875 * n1_4 * n2_4 * n3_4 + 0.578125 * n1_4 * n2_6 * (n3 * n3) + -5.171875 * (n1 * n1) * (n2 * n2) * n3_8 + 0.578125 * (n1 * n1) * n2_6 * n3_4 + 0.578125 * (n1 * n1) * n2_4 * n3_6 + -5.171875 * (n1 * n1) * n2_8 * (n3 * n3)) / (M_PI * pow(n, 19)) + (0.41015625 * n1_16 + 0.41015625 * n2_16 + 0.41015625 * n3_16 + 22.06640625 * n1_10 * n2_6 + -3.03515625 * (n1 * n1) * n2_14 + 43.1484375 * n1_8 * n2_8 + -2.953125 * n1_4 * n2_12 + -2.953125 * n1_12 * n3_4 + 43.1484375 * n2_8 * n3_8 + 22.06640625 * n1_6 * n3_10 + 43.1484375 * n1_8 * n3_8 + -2.953125 * n1_12 * n2_4 + -3.03515625 * n1_14 * (n3 * n3) + 22.06640625 * n2_10 * n3_6 + 22.06640625 * n2_6 * n3_10 + -3.03515625 * (n1 * n1) * n3_14 + -2.953125 * n2_4 * n3_12 + -3.03515625 * (n2 * n2) * n3_14 + -2.953125 * n2_12 * n3_4 + -2.953125 * n1_4 * n3_12 + 22.06640625 * n1_6 * n2_10 + 22.06640625 * n1_10 * n3_6 + -3.03515625 * n1_14 * (n2 * n2) + -3.03515625 * n2_14 * (n3 * n3) + 42.65625 * (n1 * n1) * n2_8 * n3_6 + -94.3359375 * (n1 * n1) * n2_12 * (n3 * n3) + -94.3359375 * n1_12 * (n2 * n2) * (n3 * n3) + -135.92578125 * (n1 * n1) * n2_4 * n3_10 + 221.89453125 * n1_4 * n2_8 * n3_4 + 42.65625 * n1_8 * (n2 * n2) * n3_6 + 42.65625 * n1_8 * n2_6 * (n3 * n3) + -94.3359375 * (n1 * n1) * (n2 * n2) * n3_12 + -135.92578125 * n1_10 * n2_4 * (n3 * n3) + -135.92578125 * (n1 * n1) * n2_10 * n3_4 + 709.734375 * n1_6 * n2_4 * n3_6 + 42.65625 * n1_6 * n2_8 * (n3 * n3) + 42.65625 * n1_6 * (n2 * n2) * n3_8 + -135.92578125 * n1_4 * n2_10 * (n3 * n3) + 221.89453125 * n1_4 * n2_4 * n3_8 + 221.89453125 * n1_8 * n2_4 * n3_4 + 709.734375 * n1_6 * n2_6 * n3_4 + 709.734375 * n1_4 * n2_6 * n3_6 + -135.92578125 * n1_4 * (n2 * n2) * n3_10 + -135.92578125 * n1_10 * (n2 * n2) * n3_4 + 42.65625 * (n1 * n1) * n2_6 * n3_8) / (M_PI * pow(n, 25)) + (5.452799479166667 * n1_20 + 5.452799479166667 * n2_20 + 5.452799479166667 * n3_20 + 771.5734049479166 * n1_4 * n2_16 + 771.5734049479166 * n1_16 * n3_4 + 771.5734049479166 * n2_16 * n3_4 + 2160.5162760416665 * n1_6 * n2_14 + -4788.537760416667 * n1_10 * n3_10 + 771.5734049479166 * n2_4 * n3_16 + 2160.5162760416665 * n1_14 * n2_6 + -171.49088541666666 * n1_18 * (n2 * n2) + -1182.2696940104167 * n1_12 * n2_8 + -4788.537760416667 * n2_10 * n3_10 + -1182.2696940104167 * n2_12 * n3_8 + -1182.2696940104167 * n1_8 * n3_12 + -171.49088541666666 * (n1 * n1) * n3_18 + 2160.5162760416665 * n2_14 * n3_6 + -1182.2696940104167 * n1_12 * n3_8 + -1182.2696940104167 * n2_8 * n3_12 + 2160.5162760416665 * n2_6 * n3_14 + -171.49088541666666 * (n2 * n2) * n3_18 + -4788.537760416667 * n1_10 * n2_10 + 771.5734049479166 * n1_16 * n2_4 + -171.49088541666666 * (n1 * n1) * n2_18 + 2160.5162760416665 * n1_6 * n3_14 + 771.5734049479166 * n1_4 * n3_16 + -1182.2696940104167 * n1_8 * n2_12 + 2160.5162760416665 * n1_14 * n3_6 + -171.49088541666666 * n1_18 * (n3 * n3) + -171.49088541666666 * n2_18 * (n3 * n3) + -25161.354166666668 * n1_10 * n2_8 * (n3 * n3) + 48824.31640625 * n1_8 * n2_6 * n3_6 + 1891.025390625 * n1_14 * n2_4 * (n3 * n3) + -1253.5924479166667 * (n1 * n1) * (n2 * n2) * n3_16 + 48824.31640625 * n1_6 * n2_6 * n3_8 + 48824.31640625 * n1_6 * n2_8 * n3_6 + 14754.022135416666 * n1_10 * n2_6 * n3_4 + -1253.5924479166667 * n1_16 * (n2 * n2) * (n3 * n3) + 1891.025390625 * n1_4 * (n2 * n2) * n3_14 + -2824.8326822916665 * n1_6 * (n2 * n2) * n3_12 + 1891.025390625 * (n1 * n1) * n2_4 * n3_14 + 1891.025390625 * (n1 * n1) * n2_14 * n3_4 + 14114.091796875 * n1_4 * n2_4 * n3_12 + 14114.091796875 * n1_12 * n2_4 * n3_4 + -2824.8326822916665 * (n1 * n1) * n2_12 * n3_6 + -2824.8326822916665 * n1_12 * n2_6 * (n3 * n3) + -25161.354166666668 * n1_8 * n2_10 * (n3 * n3) + -25161.354166666668 * (n1 * n1) * n2_10 * n3_8 + 14754.022135416666 * n1_4 * n2_10 * n3_6 + -2824.8326822916665 * n1_12 * (n2 * n2) * n3_6 + -25161.354166666668 * (n1 * n1) * n2_8 * n3_10 + 14754.022135416666 * n1_6 * n2_10 * n3_4 + 1891.025390625 * n1_14 * (n2 * n2) * n3_4 + 3518.7646484375 * n1_4 * n2_8 * n3_8 + -1253.5924479166667 * (n1 * n1) * n2_16 * (n3 * n3) + 3518.7646484375 * n1_8 * n2_4 * n3_8 + -25161.354166666668 * n1_10 * (n2 * n2) * n3_8 + 14754.022135416666 * n1_10 * n2_4 * n3_6 + -25161.354166666668 * n1_8 * (n2 * n2) * n3_10 + 3518.7646484375 * n1_8 * n2_8 * n3_4 + 14754.022135416666 * n1_6 * n2_4 * n3_10 + 1891.025390625 * n1_4 * n2_14 * (n3 * n3) + 14754.022135416666 * n1_4 * n2_6 * n3_10 + 14114.091796875 * n1_4 * n2_12 * n3_4 + -2824.8326822916665 * (n1 * n1) * n2_6 * n3_12 + -2824.8326822916665 * n1_6 * n2_12 * (n3 * n3)) / (M_PI * pow(n, 31)) + 1 / (12.566370614359172 * n * 1);
}
