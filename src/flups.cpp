...
inline static int flups_ranksplit(const int rank, const int axproc[3], const int nproc[3], MPI_Comm comm, int rankd[3]) {
    return ranksplit(rank, axproc, nproc, comm, rankd);
}
